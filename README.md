...
**edge** is the development tag for the **9.5.7** release tag.

    docker pull ewsdocker/debian-netsurf:edge
    docker tag ewsdocker/debian-netsurf:edge ewsdocker/debian-netsurf:9.5.7
...
To create and run the container, the following should work from the command-line, 
    ...
    ~/.local/bin/debian-netsurf-9.5.7  
